      ...
      <div className="flex items-center ml-[1.5%] py-[0.5%]">
        ...
        <div>
            <ul className='flex justify-center w-full mt-[1%] text-[1.1em] font-medium'>
                <li className={`w-[50%] text-center hover:cursor-pointer ${isFollowing ? 'text-black border-b-[5px] pb-[0.6%] border-primary' : 'text-[#9D9D9D]'}`}
                    onClick={()=>setIsFollowing(true)}>
                    <p className='hover:cursor-pointer'>Following</p>
                </li>
                <li className={`w-[50%] text-center text-[#9D9D9D] hover:cursor-pointer ${isFollowing ? 'text-[#9D9D9D]' : 'text-black border-b-[5px] pb-[0.6%] border-primary'}`}
