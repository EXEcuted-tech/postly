  ...
  return (
    <div className="animate-fade-in flex-row  h-full w-full pr-[20%]">
      ...
      <div className="flex justify-center items-center mb-[1%]">
        <p className="text-[1.4em] font-poppins text-[#5E5C5C]">
        ...
        <div className="flex h-14 w-[70%] mt- space-x-4 justify-center items-center">
          {digits.map((digit, index) => (
            <input
              ...
              className="relative z-[100] w-14 h-14 text-center border border-yellow-400 rounded"
            />
          ))}
        </div>
      </div>
      <div className="flex justify-center items-center mt-[2%]">
        <p className="text-[1.3em] font-poppins text-[#989898] font-semibold">
