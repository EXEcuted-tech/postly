...
const Delete = () => {
  return (
    <div className='w-full h-full bg-gray-900'>
      <div className='absolute w-[50%] h-[55%] top-[22%] left-[25%] rounded-[50px] shadow-2xl'>
          ...
          <div className='flex ml-[5%]'>
            <form className='inline text-black w-[89%]'>
              <div className='ml-[3%] mb-[2%] w-full text-center'>
                <p className='font-semibold text-5xl'>Are You Sure?</p>
              </div>
              <div className='ml-[3%] w-full text-center'>
                <p className='font-normal text-4xl'>Do you want to delete this task? This</p>
              </div>
              <div className='ml-[3%] mb-[2%] w-full text-center'>
                <p className='font-normal text-4xl'>process cannot be undone.</p>
              </div>
              <div className='flex justify-center mt-[2%]'>
                <button type='submit' className=' bg-[#6C6C6C] text-white text-3xl w-[20%] py-[2%] mt-[1%] mr-[10%] font-bold rounded-md'>Cancel</button>
