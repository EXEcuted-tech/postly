  ...
  return (
    <div>
        ...
        <div className='mx-[7%]'>
            ...
            Sa isang sulyap mo ay nabihag ako para bang himala ang lahat ng ito sa isang sulyap
            mo yawa yawa ka ty HAAHAHAHAHAH PISTE NANG COVER PHOTO asdfasdfasdfasfasfasdf
            </p>
        </div>
        <hr className='my-[1%]'/>
    </div>
